...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "https://711ea08f74e4.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "https://711ea08f74e4.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  dislikedArticle = () => {
    const url = "https://711ea08f74e4.ngrok.io/disliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
            ...
            <View style={styles.subBottomContainer}>
              ...
              <View style={styles.lowerBottomContainer}>
                <View style={styles.iconButtonContainer}>
                  ...
                  <TouchableOpacity onPress={this.dislikedArticle}>
                    <Icon
                      reverse
                      name={"cross"}
                      type={"entypo"}
